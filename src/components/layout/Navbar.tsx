export default function Navbar() {
  return (
    <nav className="fixed top-0 left-0 w-full z-50 px-8 md:px-16 py-6 flex justify-between items-center backdrop-blur-sm">
      <span className="text-lg font-bold text-white">TU_NOMBRE</span>
